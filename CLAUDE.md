...
**核心词的义项上限是 50** —— 编号只到 ㊿，超了 renumber.py 会直接崩。
back 就正好顶到 50。装不下的复合词不要硬塞，改成单独立条：
它们多半是单义的，单列反而更清楚，也不会把核心词条撑成一堵墙。
挑哪些留在核心词里：能从底层义推出来的（短语动词、习语）留下，
只是碰巧同词根的具体名词（backplane、backstitch）拿出去。
