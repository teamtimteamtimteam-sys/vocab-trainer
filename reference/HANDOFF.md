...
- **补例句**：tier1 剩 678，tier2（词族）841。**e 段与 fa / fe / fi 段都清空了**，
  **下一段 fl / fo / fr / fu**（按词条数算 fl 48、fo 30、fr 28、fu 17；
  上百条的大段按词头分两三批做，每批 30–65 条，各自过闸各自提交）。
  fi 段 128 条是拆成四批做的：fiasco–figure / file–fiord / fire 一族 / first–fixed。
